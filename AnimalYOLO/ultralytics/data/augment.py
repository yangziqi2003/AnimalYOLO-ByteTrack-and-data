...
class BaseTransform:
    ...
    Methods:
        ...
        apply_image: Applies image transformation to labels_xml.
        apply_instances: Applies transformations to object instances in labels_xml.
    ...
    def apply_image(self, labels):
        """Applies image transformations to labels_xml."""
        pass

    def apply_instances(self, labels):
        """Applies transformations to object instances in labels_xml."""
        pass
...
class BaseMixTransform:
    ...
    def __call__(self, labels):
        """Applies pre-processing transforms and mixup/mosaic transforms to labels_xml data."""
...
class Mosaic(BaseMixTransform):
    ...
    def _mix_transform(self, labels):
        """Apply mixup transformation to the input image and labels_xml."""
    ...
    def _cat_labels(self, mosaic_labels):
        """Return labels_xml with mosaic border instances clipped."""
...
class RandomPerspective:
    ...
    Methods:
        ...
        __call__(labels_xml): Main method to apply transformations to both images and their corresponding annotations.
...
class RandomHSV:
    ...
    def __call__(self, labels):
        ...
        The modified image replaces the original image in the input 'labels_xml' dict.
        """
        img = labels['img']
...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        """Return updated labels_xml and image with added border."""
        if labels is None:
            labels = {}
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing:
                           ...
                           - 'cls': Class labels_xml associated with the instances.
        ...
        Notes:
            ...
            2. This method modifies the input dictionary 'labels_xml' in place.
        """
        im = labels['img']
        cls = labels['cls']
        h, w = im.shape[:2]
