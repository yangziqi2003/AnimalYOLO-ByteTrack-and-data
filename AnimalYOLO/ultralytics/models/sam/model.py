...
class SAM(Model):
    ...
    bounding boxes, points, or labels_xml. The model has capabilities for zero-shot performance and is trained on the SA-1B
    dataset.
    """
    ...
    def predict(self, source, stream=False, bboxes=None, points=None, labels=None, **kwargs):
        ...
        Args:
            ...
            labels (list, optional): List of labels_xml for prompted segmentation. Defaults to None.
