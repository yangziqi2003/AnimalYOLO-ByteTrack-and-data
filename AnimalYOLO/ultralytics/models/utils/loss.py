...
class DETRLoss(nn.Module):
    ...
    Attributes:
        ...
        use_uni_match (bool): Whether to use a fixed layer to assign labels_xml for the auxiliary branch.
    ...
    def __init__(self,
        ...
        Args:
            ...
            use_vfl (bool): Use VarifocalLoss or not.
            use_uni_match (bool): Whether to use a fixed layer to assign labels_xml for auxiliary branch.
