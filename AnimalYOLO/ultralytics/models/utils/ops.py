...
def get_cdn_group(batch,
    ...
    and negative samples from the ground truths (gt). It applies noise to the class labels_xml and bounding box coordinates,
    and returns the modified labels_xml, bounding boxes, attention mask and meta information.
    ...
    Args:
        ...
        class_embed (torch.Tensor): Embedding weights to map class labels_xml to embedding space.
        num_dn (int, optional): Number of denoising. Defaults to 100.
        cls_noise_ratio (float, optional): Noise ratio for class labels_xml. Defaults to 0.5.
