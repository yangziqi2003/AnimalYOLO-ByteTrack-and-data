...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=False, example='abc'):
        ...
        non_ascii = not is_ascii(example)  # non-latin labels_xml, i.e. asian, arabic, cyrillic
    ...
    def count_labels(self, in_count=0, out_count=0, color=(255, 255, 255), txt_color=(0, 0, 0)):
        ...
        # Calculate positions for in_count and out_count labels_xml
...
def plot_labels(boxes, cls, names=(), save_dir=Path(''), on_plot=None):
    """Plot training labels_xml including class histograms and box statistics."""
    import pandas as pd
    ...
    # Plot dataset labels_xml
    LOGGER.info(f"Plotting labels_xml to {save_dir / 'labels_xml.jpg'}... ")
...
def plot_images(images,
                ...
                names=None,
                on_plot=None):
    """Plot image grid with labels_xml."""
    ...
    for i in range(i + 1):
        ...
        if len(cls) > 0:
            ...
            if len(bboxes):
                ...
                labels = bboxes.shape[1] == 4  # labels_xml if no conf column
