...
class ConfusionMatrix:
    ...
    def process_cls_preds(self, preds, targets):
        ...
        Args:
            preds (Array[N, min(nc,5)]): Predicted class labels_xml.
            targets (Array[N, 1]): Ground truth class labels_xml.
        """
    ...
    def process_batch(self, detections, labels):
        ...
        Args:
            ...
            labels (Array[M, 5]): Ground truth bounding boxes and their associated class labels_xml.
                                  Each row should contain (class, x1, y1, x2, y2).
        """
        if labels.size(0) == 0:  # Check if labels_xml is empty
    ...
    def plot(self, normalize=True, save_dir='', names=(), on_plot=None):
        ...
        Args:
            ...
            names (tuple): Names of classes, used as labels_xml on the plot.
...
def ap_per_class(tp,
    ...
    for ci, c in enumerate(unique_classes):
        i = pred_cls == c
        n_l = nt[ci]  # number of labels_xml
